...
d_fetcher_init_param = {'log_callback': log_cb, 'proxy': 'http://127.0.0.1:10809', 'timeout_s': 60, 'stealth': True, 'pause_browser': False, 'render_page': True}
e_fetcher_init_param = {'log_callback': log_cb, 'proxy': 'http://127.0.0.1:10809', 'timeout_s': 60, 'stealth': True, 'pause_browser': False, 'render_page': True}
...
start_date = None
end_date = None
d_fetcher_kwargs = {'wait_until': 'networkidle', 'wait_for_selector': None, 'wait_for_timeout_s': 60, 'scroll_pages': 5}
e_fetcher_kwargs = {'wait_until': 'networkidle', 'wait_for_selector': None, 'wait_for_timeout_s': 60, 'scroll_pages': 0}
extractor_kwargs = {}
channel_filter_list = []
